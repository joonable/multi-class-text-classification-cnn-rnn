...
def build_vocab(sentences):
	...
	vocabulary_inv = [word[0] for word in word_counts.most_common()]        #list
	# {word1 : cnt1, word2 : cnt2 ... } => [word1, word2, ...]
	vocabulary = {word:index for index, word in enumerate(vocabulary_inv)}      #dict
	# [word1, word2, ...] => {word1 : 0, word2 : 1... }
